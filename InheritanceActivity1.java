...
public class InheritanceActivity1 {
    public static void main(String[] args) {
        ...
        System.out.println("Trainee's salary: " + t.calculateSalary());
        System.out.println("Manager's transport allowance: " + m.calculateTransportAllowance());
        System.out.println("Trainee's transport allowance: " + t.calculateTransportAllowance());
    }
}
